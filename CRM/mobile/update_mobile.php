  ...
  if ($result)
  {
    ...
    echo '
        <table>
          <tr>
            <td>
            <form method="post" autocomplete="off" enctype="multipart/form-data" id="updateForm" action="update_mobile.php?id='.$currentID.'">
            <div>
            ...
            <div class="form_action">
              <button type="update" name="update" value="Update">Update</button><a href="index_mobile.php"><button>Cancel</button><a/>
            </div>
